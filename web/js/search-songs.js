          ...
          songItem.innerHTML = `
                        <div class="music-container-left">
                            ...
                            <div class="music-name">
                                <h3 class="song-title" onclick=add_play_music(this) style="color: var(--text-primary); margin: 0" data-id=${song.id} data-platform=${encodeURIComponent(platform)}>${song.title}</h3>
